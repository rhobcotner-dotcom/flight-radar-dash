...
function pickPopupProps(source) {
  return {
    ...
    emergencyStatus: source.emergencyStatus ?? source.status ?? null,
    ...
    agencyName: source.agencyName ?? source.agency ?? null,
    city: source.city ?? null,
    observedAt: source.observedAt ?? null,
    closedAt: source.closedAt ?? null,
    status: source.status ?? null,
    alarmLevel: source.alarmLevel ?? null,
    priority: source.priority ?? null,
    incidentNumber: source.incidentNumber ?? null,
    units: source.units ?? null,
    locationNotes: source.locationNotes ?? null,
    details: source.details ?? null,
    sourceType: source.sourceType ?? null,
    pulsePointCallType: source.pulsePointCallType ?? null,
